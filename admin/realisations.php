                    ...
                    <div class="col-lg-12">
                        ...
                        <table class="table table-striped">
							<thead> 
								<tr class="info">
									...
									<th id="centrer" scope="col">Description</th>
						...
						<form class="form-horizontal" method="post" action="realisations.php">
							...
							<div class="form-group">
								...
								<div class="col-md-4">                     
									<textarea name="description_r" cols="80" rows="4" class="form-control" id="description" placeholder="description de l'expérience"></textarea>
								</div>
							</div>
