...
// j'execute les requêtes
		$pdoCV->exec(" UPDATE t_realisations SET titre_r='$titre' WHERE id_realisation='$id_realisation' ");
		$pdoCV->exec(" UPDATE t_realisations SET sous_titre_r='$sous_titre' WHERE id_realisation='$id_realisation' ");
		$pdoCV->exec(" UPDATE t_realisations SET description_r='$description' WHERE id_realisation='$id_realisation' ");
		$pdoCV->exec(" UPDATE t_realisations SET dates_r='$dates' WHERE id_realisation='$id_realisation' ");
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="modif_realisation.php?id_realisation=<?= $ligne['id_realisation']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
									<td><a href="realisations.php?id_realisation=<?= $ligne['id_realisation']; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
								</tr>
								<?php } ?>
							</tbody>
						</table>
						<form class="form-horizontal" method="post" action="modif_realisation.php">
							...
							<!-- Text input-->
							<div class="form-group">
								<label for="sous_titre_r" class="col-md-4 control-label" >Sous-titre</label>  
								<div class="col-md-4">
							...
							<!-- Text input-->
							<div class="form-group">
								<label for="dates_r" class="col-md-4 control-label" >Titre de l'expérience</label>  
								<div class="col-md-4">
